...
#         self.paginas = ""
  ...
  def compilarListasDeItems(self):
    ...
    for membro in self.listaDeMembros:
      ...
      # prof = Professor(membro.nomeCompleto, membro.nomeEmCitacoesBibliograficas, membro.textoResumo, membro.idLattes,
      #                  membro.bolsaProdutividade, membro.enderecoProfissional)

      # print(membro.listaArtigoEmPeriodico)
